...
import vertexai
from langchain_community.embeddings import HuggingFaceEmbeddings # Add this (or langchain_huggingface if newer langchain)
...
EMBEDDING_FUNCTION = HuggingFaceEmbeddings(
    ...
    model_kwargs={'device': "cpu"}, # Set to None for automatic device selection (CPU, CUDA, MPS)
