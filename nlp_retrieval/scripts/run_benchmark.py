...
from darelabdb.nlp_retrieval.retrievers.ragatouille_colbert_retriever import RagatouilleColbertRetriever
from darelabdb.nlp_retrieval.retrievers.minhash_lsh_retriever import MinHashLshRetriever
from darelabdb.nlp_retrieval.rerankers.bge_cross_encoder_reranker import BgeReranker
from darelabdb.nlp_retrieval.rerankers.llm_reranker import LLMReranker
from darelabdb.nlp_retrieval.rerankers.mxbai_cross_encoder_reranker import MxbaiCrossEncoderReranker
from darelabdb.nlp_retrieval.rerankers.bridge_reranker import BridgeReranker
from darelabdb.nlp_retrieval.rerankers.sentence_transformer_reranker import SentenceTransformerCrossEncoderReranker
from darelabdb.nlp_retrieval.user_query_processors.keybert_query_processor import KeyBERTProcessor
from darelabdb.nlp_retrieval.user_query_processors.llm_decomposition_query_processor import DecompositionProcessor
...
from darelabdb.nlp_retrieval.user_query_processors.ner_query_processor import NERQueryProcessor
from darelabdb.nlp_retrieval.user_query_processors.ngram_processor import NgramQueryProcessor


DATA_FILE = "components/darelabdb/nlp_retrieval/test_data/multi_hop_rag.jsonl"
BENCHMARK_FILE = "components/darelabdb/nlp_retrieval/test_data/benchmarks/multi_hop_rag.json"
DATA_WITH_IDS_FILE = "components/darelabdb/nlp_retrieval/test_data/temp/data_with_ids.jsonl"
...
def prepare_benchmark_data(benchmark_file_path: str) -> Tuple[List[str], List[List[RetrievalResult]]]:
    """
