    ...
    def run(self):
        ...
        for run_name, searcher in self.searcher_configs:
            ...
            if self.use_wandb:
                ...
                wandb.summary[
                    "FullResults_Perfect_Recall_Rate"
                ] = full_summary.perfect_recall_rate
                wandb.summary[
                    "FullResults_Recall_Non_Numerical"
                ] = full_summary.overall_recall_non_numerical
                wandb.summary[
                    "FullResults_Perfect_Recall_Rate_Non_Numerical"
            ...
            for k in sorted(self.k_values):
                ...
                if self.use_wandb:
                    ...
                    wandb.summary[
                        f"Perfect_Recall_Rate@{k}"
                    ] = summary.perfect_recall_rate
                    wandb.summary[
                        f"Recall_Non_Numerical@{k}"
                    ] = summary.overall_recall_non_numerical
                    wandb.summary[
                        f"Perfect_Recall_Rate_Non_Numerical@{k}"
