...
if __name__ == "__main__":
    ...
    output_filename = "find_value_synonyms.json"
    output_path = f"{output_folder}/{output_filename}"
    ...
    BenchmarkVariator.find_hard_synonyms_with_vllm(
        "assets/value_linking_valid_values_exact_no_bird_train.json",
        "/data/hdd1/users/akouk/value_linking/fresh_value_linking/experimental-analysis-of-value-inking/CHESS/data/value_linking/dev_databases",
        output_json_path = output_path
    )